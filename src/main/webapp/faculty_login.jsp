...
/*		if(session.getAttribute("FacultyErrorLogin") != null)
		{
			out.println(session.getAttribute("FacultyErrorLogin"));
		}
...
%>
                        ...
                        <!-- Forgot Password -->
                        <a href="faculty_register.jsp" class="registration"> You dont't have an account? <b> Register here </b> </a>
                    </div>

                    <%
	// getting all required fields of login of faculty for validation
	...
	try
	{
		...
		if(rs.next())
		{
			...
			{
				session.setAttribute("faculty",rs.getString(1));
				response.sendRedirect("faculty_dashboard.jsp");
			}
		}
		...
		{
			// create a SQL statement
			String sql1 = "select * from faculty where username = '" + username + "'";
